export function CSSSvg({width,height}:{width:number,height:number}){

    return (
        <svg fill="none" width={width} height={height}  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 124 141.53">
